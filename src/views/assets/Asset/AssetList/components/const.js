        ...
        formatterArgs: {
          ...
          extraActions: [
            ...
            },
            {
              ...
              divided: true,
              can: ({ row }) => !vm.$store.getters.currentOrgIsRoot && vm.$hasPerm('accounts.add_account'),
              callback: ({ row }) => {
                vm.asset = row
            ...
            },
            {
              ...
              can: ({ row }) => !vm.$store.getters.currentOrgIsRoot && vm.$hasPerm('accounts.add_gatheraccountsexecution'),
              callback: ({ row }) => {
